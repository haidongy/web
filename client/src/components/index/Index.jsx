...
export default class MIndex extends Component {
    CountUp(){
        ...
        let imgName = ["邮件","对话","购物车","收藏"];
        let count = ["2017","768","1","500"];
    ...
    getOption(){
        let option = {
            ...
            series: [{
                ...
                symbolSize: 8,
                symbol: 'circle',
                data: [10, 40, 32, 20, 80, 90, 97, 45, 80, 95, 60, 45]
            }, {
                name: '线下',
                smooth: true,
                type: 'line',
                symbolSize: 8,
                symbol: 'circle',
                data: [70, 50, 50, 87, 90, 80, 70, 20, 80, 90, 97, 45]
            },{
                name: '其他',
                smooth: true,
                type: 'line',
                symbolSize: 8,
                symbol: 'circle',
                data: [30, 40, 10, 20, 33, 66, 54, 50, 50, 87, 90, 80]
            }]
        };
        return option;
    }
                        ...
                        <Col md={8}>
                            <Card
                                ...
                                <div className='avatar'>
                                    ...
                                    />
                                    <div>haidong.yang</div>
                                    <div>haidong.yang@outlook.com</div>
                                </div>
